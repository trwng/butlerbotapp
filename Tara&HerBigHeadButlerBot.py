...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                             QLabel, QPushButton, QStackedWidget, QFrame, QSizePolicy, QStyle)
...
# In your ButlerBotApp class, update the update_camera method
...
class ButlerBotApp(QMainWindow):
    ...
    def init_sidebar(self):
        ...
        if os.path.exists(camera_icon_path):
            ...
            camera_btn.setIcon(self.style().standardIcon(QStyle.SP_ComputerIcon))
        ...
        if os.path.exists(sensor_icon_path):
            ...
            sensor_btn.setIcon(self.style().standardIcon(QStyle.SP_FileDialogContentsView))
        ...
        # Music button
        music_btn = QPushButton("Nutrition")
        music_icon_path = os.path.join(script_dir, "music1.png")
        if os.path.exists(music_icon_path):
            music_btn.setIcon(QIcon(music_icon_path))
        else:
        ...
        music_btn.clicked.connect(self.show_music)
        sidebar_layout.addWidget(music_btn)
        self.menu_buttons["Nutrition"] = music_btn
    ...
    def init_music_view(self):
        ...
        # Create song label BEFORE calling load_playlist
        self.song_label = QLabel("Now Playing: Nothing")
        self.song_label.setStyleSheet("font-size: 18px; color: #34495e;")
        ...
        # Now it's safe to load the playlist
        script_dir = os.path.dirname(os.path.abspath(__file__))
        music_folder = os.path.join(script_dir, "butlerbotapp-main\\Music")
        self.load_playlist(music_folder)
    ...
    def play_current_song(self):
        if not self.playlist:
            self.song_label.setText("Playlist is empty.")
            return
        ...
        if os.path.exists(song_path):
            ...
            self.song_label.setText("File not found.")
    ...
    def init_settings_view(self):
        ...
        # You can add any settings widgets here later
        # For now, just add a placeholder label
        placeholder = QLabel("Settings go here...")
        placeholder.setStyleSheet("font-size: 18px; color: #34495e;")
    ...
    def init_camera_view(self):
        ...
        camera_container.setFixedSize(800, 600)
    ...
    def capture_image(self):
        if self.cap and self.cap.isOpened():
            ...
            if ret:
                ...
                # Show a notification
                self.show_notification("Image captured and saved as captured_image.png")
    ...
    def show_nutrition(self):
        self.stacked_widget.setCurrentWidget(self.nutrtion_view)
